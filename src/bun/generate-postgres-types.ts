...
import type { EnumData } from "../shared/generate-enums"

import { pascalCase } from "../shared/case"

type TypeContext = "JsonSelectable" | "Selectable" | "Insertable" | "Updatable" | "Whereable"

let warnedAboutInt8AndNumeric = false

export function __resetGeneratePostgresTypesStateForTests() {
  warnedAboutInt8AndNumeric = false
}
